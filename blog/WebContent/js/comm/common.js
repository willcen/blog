...
var path = __CreateJSPath("common.js");
path = path.replace("/js/comm/", "");
window.g_path = path;

document.write('<script src="' + path + '/assets/js/jquery.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/assets/js/amazeui.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/assets/js/amazeui.widgets.helper.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/assets/js/handlebars.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="' + path + '/assets/css/amazeui.css" rel="stylesheet" type="text/css" />');
document.write('<link href="' + path + '/assets/css/app.css" rel="stylesheet" type="text/css" />');
//document.write('<link href="' + path + '/assets/css/amazeui.css" rel="stylesheet" type="text/css" />');
/**
 * 异步ajax请求
 * @param url，必填
